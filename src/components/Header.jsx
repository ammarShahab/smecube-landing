...
const Header = ({ mobileMenuOpen, scrolled, setMobileMenuOpen }) => {
  const navItems = [
    { name: "হোম", path: "/" },
    { name: "সার্ভিস", path: "/services" },
    { name: "প্রাইসিং", path: "/pricing" },
    { name: "যোগাযোগ", path: "/contact" },
    // { name: "ক্লায়েন্ট এরিয়া", path: "/client-area" },
  ];
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-6 space-y-2 bg-white border-t">
            <a
              href="#home"
              className="block px-4 py-3 text-gray-700 hover:bg-red-50 hover:text-red-500 rounded-lg transition-colors font-medium"
            >
              হোম
            </a>
            <a
