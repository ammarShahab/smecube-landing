...
const HeroSection = () => {
  return (
    <section
      className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 overflow-hidden"
      id="home"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              এসএমই কিউব - আপনার সম্পূর্ণ ডিজিটাল সমাধানী। ওয়েবসাইট, ই-কমার্স,
              মার্কেটিং থেকে শুরু করে ব্যবসায়িক পরামর্শ - সবকিছু এক জায়গায়।
            </p>
